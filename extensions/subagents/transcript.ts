...
export function messageToTranscript(
  message: unknown,
...
export function messageStopReason(message: unknown): string | undefined {
  return message &&
    typeof message === "object" &&
    typeof (message as Record<string, unknown>).stopReason === "string"
...
export function messageError(message: unknown): string | undefined {
  return message &&
    typeof message === "object" &&
    typeof (message as Record<string, unknown>).errorMessage === "string"
...
export function boundedWebTranscript(
