...
export interface AppEditorComponent extends EditorComponent, Partial<Focusable> {
...
export async function showManager(manager: SubagentManager, ctx: ExtensionContext): Promise<void> {
	if (ctx.mode !== "tui") {
