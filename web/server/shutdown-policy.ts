...
export function shouldRejectDuringShutdown(message: { type: string; command?: { type?: string } }): boolean {
	return message.type === "client.prompt" || (message.type === "client.command" && message.command?.type !== "abort");
}
